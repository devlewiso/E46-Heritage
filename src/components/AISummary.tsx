...
const summaries: Record<string, string> = {
  ...
  audio: `Sistema de sonido orientado a High Fidelity con jerarquía clara. El HELIX M ONE es el músculo — amplificador mono alemán entregando ~350W activos al Soundstream XP12 cableado a 2Ω. El Alpine S2-A36F maneja los 4 canales de mids y highs con su firma de sonido cálida y natural. El sub ya está en su configuración óptima: DVC 4Ω en paralelo a 2Ω. El único eslabón a mejorar son los Sony de puertas — cuando se reemplacen, el sistema sube un nivel completo.`,
  ...
  'audio-helix': `Amplificador mono de ingeniería alemana — el más fino del sistema. 600W RMS a 1Ω en Clase D, eficiencia superior al 90%. El Soundstream XP12 está cableado a 2Ω (DVC en paralelo), por lo que el HELIX está entregando ~350W activos — configuración correcta y dentro del rango óptimo. Capacidad total a 1Ω disponible si en el futuro se agrega un segundo subwoofer.`,
  ...
  'audio-soundstream': `Subwoofer de 12 pulgadas con imán doble de 120 onzas — motor de fuerza real. DVC 4Ω cableado en paralelo: las dos bobinas de 4Ω conectadas juntas dan una carga de 2Ω al amplificador. El HELIX M ONE entrega ~350W activos en esa configuración. El sub tiene margen amplio — aguanta 750W RMS. Respuesta desde 25Hz: presión física en el baúl, no solo volumen. Configuración actual: óptima.`,
